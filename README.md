![ai-knowledge-graph-example](https://github.com/aimaster-dev/knowledge-graph-construction/blob/main/data/ai-knowledge-graph-example.png)
...
A demo of a knowlege graph created with this project can be found here: [test]([https://robert-mcdermott.github.io/ai-knowledge-graph/](https://aimaster-dev.github.io/knowledge-website/))
